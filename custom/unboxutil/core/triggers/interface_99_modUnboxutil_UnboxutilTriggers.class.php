...
//                if ((count($prodsfather) > 0) && ($object->desdepadre == 0)) {
            ...
            $sql ="SELECT custy AS cus FROM "  . MAIN_DB_PREFIX . "commande_extrafields ";
            ...
            elseif($custy == 2){
            $sql2  ="UPDATE "  . MAIN_DB_PREFIX . "commande  SET fk_availability = 3, date_livraison = DATE_ADD(date_commande, INTERVAL 2 WEEK) ";
            $sql2 .=" WHERE rowid = ". $object->id;
